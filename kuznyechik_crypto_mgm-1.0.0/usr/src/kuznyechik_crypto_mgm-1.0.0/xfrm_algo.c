...
#ifndef SADB_X_EALG_KUZNYECHIK_MGM_KTREE
#define SADB_X_EALG_KUZNYECHIK_MGM_KTREE   31
#endif
...
},
{
    ...
    .desc = {
        .sadb_alg_id = SADB_X_EALG_KUZNYECHIK_MGM_KTREE,
        .sadb_alg_ivlen = 8,
